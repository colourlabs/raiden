...
namespace Raiden::Physics { class IPhysicsSystem; }
...
public:
  ...
  virtual bool init(::Raiden::Renderer::IRenderDevice &device, ::Raiden::Core::IVirtualFileSystem &vfs, ::Raiden::Assets::IAssetManager &assets, ::Raiden::Platform::IPlatform *platform, ::Raiden::Audio::IAudioDevice *audio = nullptr, ::Raiden::Physics::IPhysicsSystem *physics = nullptr) = 0;
